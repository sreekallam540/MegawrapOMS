		...
		<div class="main-inner">
			...
			Order Expired Date : <span style="color: red"><%= dateFormat.format(order.getExpiredDate().getTime()) %>
									...
									<div class="login-fields">
										...
										<div class="field">
											<label for="remarks">Company Site:</label> Company Site:
											<form:input path="companySite" id="companySite"
												name="companySite" value="" placeholder="Company Site URL"
												class="login" style="width: 500px" />
										</div>
										<!-- /field -->

										<div class="field">
											<label for="remarks">Logo Reference:</label> Logo Reference:
											<form:input path="companyIcon" id="companyIcon"
												name="companyIcon" value="" placeholder="Company Icon URL"
												class="login" style="width: 500px" />
										</div>
										<!-- /field -->

										<div class="field">
											<label for="remarks">Company Description:</label> Company
											Description:
											<form:input path="companyDescription" id="companyDescription"
												name="companyDescription" value=""
