...
%>
	...
	<div class="main">
		<div class="main-inner">
			...
			<span style="color: green;"><b>Created Date :</b></span> <span style="color: blue;"><%= dateFormat.format(order.getCreationDate().getTime()) %></span>
									<br /> 	<span style="color: green;"><b>Last Modified :</b></span> <span style="color: black;"><%= dateFormat.format(order.getLastModified().getTime()) %>
									</span>
									<br />
			...
			Order Expired Date : <span style="color: red"><%= dateFormat.format(order.getExpiredDate().getTime()) %>
									...
									<div class="login-fields">
										...
										<div class="field">
											<label for="orderUrl">Source Url</label> URL:
