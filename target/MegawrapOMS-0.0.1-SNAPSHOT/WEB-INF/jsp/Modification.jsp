...
<%@page
	import="com.propellum.oms.entities.Order,java.text.SimpleDateFormat,java.util.Calendar,com.propellum.oms.entities.OrderModification, com.propellum.oms.entities.OrderModificationEntry"%>
			...
			<div class="container">
				<div class="row">
					...
					<div class="span6" style="height: auto;">
						...
						<label for="username"><b>Order Name:</b> <%= order.getOrderName() %>
						</label> <label for="username"><b>URL:</b> <%= order.getOrderUrl() %></label>
						...
						<hr>
							<h4 align="center">
								Modifications by <%= orderModification.getUserId() %> on <%= dateFormat.format(orderModification.getOrderModificationDate().getTime()) %>
							</h4>
						<%if(orderModification.getRemark()!=null){ %>
						<label for="username"
							style="display: inline-block; padding: 5px 5px 0px;">Comments:
