...
<%-- <div class="main">
	...
	<div class="span6" >
			...
			<% }%>
				...
				<!-- Status Count Icons END -->					
	<table id="dataTable" data-empty="There are no rows" class="table footable footable-1 footable-filtering footable-filtering-right footable-paging footable-paging-center breakpoint-lg" data-state="true" data-paging="true" data-paging-count-format="{PL} of {TR}" data-paging-size="15" data-sorting="true" data-filter="#filter" data-filtering="true"  >
		<thead>
			<tr><td colspan="5">
				<div class="well">
			...
			<tr style="background-color: grey;">
				<th data-sortable="true" ><% if(client.equals("chronicle")) {%>	Institution Name Alias  <% }else {	%>	Company Name <%}%><span class="fooicon fooicon-sort"></span></th>
				<th data-sortable="true" data-value="status">Status</th>
				<th data-sortable="true" data-sorted="true" data-direction="DESC" data-type="date" data-format-string="dd MMMM YYYY">Last Modified Date</th>
				<% if(client.equals("chronicle")) {%> <th data-sortable="true" data-breakpoints="xs" >Customization (YES/NO)</th><% }%>
				<th data-type="html" data-sortable="false">Option</th>
			</tr>
		</thead>
...
$('[name=status]').on('change', function(){
	var filtering = FooTable.get('#filter').use(FooTable.Filtering), // get the filtering component for the table
